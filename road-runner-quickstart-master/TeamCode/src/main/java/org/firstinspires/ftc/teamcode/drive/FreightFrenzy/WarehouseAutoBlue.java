...
public class WarehouseAutoBlue extends LinearOpMode {
    ...
    public void driveOut(Pose2d endPoint){
        ...
        drive.v4barOffset = Math.toRadians(-4); drive.slidesOffset = -0.5; drive.turretOffset = Math.toRadians(6 * side); // 1
    ...
    public void depositFirst(int capNum, Pose2d endPoint){
        ...
        double offset = 0;
        switch (capNum) {
            case 0: r = 9.25; h = 2.5; drive.slidesOffset = -3.25; offset = -1; drive.turretOffset = Math.toRadians(-6 * side); break;
            case 1: r = 7; h = 7.125; offset = 3.25; drive.turretOffset = Math.toRadians(-6.2 * side); break;
